 ...
 *   rank        — returns all 35 papers ranked by SCC
 *   context     — returns the full context manifest
 *   manifest    — worker manifest with all capabilities
 *
 * ANIMA MICRO: 618ms heartbeat | CONTEXTURA-VIVA | All 35 papers synthesized
 */
...
// ══════════════════════════════════════════════════════════════════════════════
// FORMULAS — All key formulas from all 35 papers, keyed by domain
// ══════════════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════════════
// PAPER_RANKING — All 35 papers ranked by SCC descending
// ══════════════════════════════════════════════════════════════════════════════
...
const PAPER_RANKING = [
  ...
  { rank: 32, id: 'PAPER-XXX',   title: 'De Runtime Nova',                       scc: 4.76, engine: 'Nova Runtime Root+vita-aeterna.ocl+civilization.cpl-l',                                        domain: 'runtime-governance'         },
  { rank: 33, id: 'PAPER-XXXI',  title: 'De Runtime Memoriae Activae',           scc: 4.79, engine: 'Memory Runtime+Active State Runtime+Semper Memoria contracts',                                 domain: 'memory-runtime'             },
  { rank: 34, id: 'PAPER-XXXII', title: 'De Fundamento Computationis',           scc: 4.74, engine: 'Foundation Floor Runtime+civilization-runtime.cpl-p+civilization.cpl-l',                     domain: 'foundation-floor'           },
  { rank: 35, id: 'PAPER-XXXIII', title: 'De Civitate AIS Synaptica',            scc: 4.88, engine: 'active_state_civilization_fleet.json+FULL_SPEC_V2_RUNTIME.md+DISSERTATIO_XXXIII_CIVITAS_AIS.md', domain: 'multi-ai-civilization'      },
];
...
const DOMAIN_KEYWORDS = {
  ...
  runtime:       { formulaKey: 'kuramoto',      paperIds: ['PAPER-XXX', 'PAPER-XXXI']},
  nova:          { formulaKey: 'phi',           paperIds: ['PAPER-XXX']              },
  active:        { formulaKey: 'salience',      paperIds: ['PAPER-XXXI']             },
  foundation:    { formulaKey: 'antifragile',   paperIds: ['PAPER-XXXII']            },
  floor:         { formulaKey: 'antifragile',   paperIds: ['PAPER-XXXII']            },
  fleet:         { formulaKey: 'kuramoto',      paperIds: ['PAPER-XXXIII']          },
  alpha:         { formulaKey: 'phi',           paperIds: ['PAPER-XXXIII']          },
  bridge:        { formulaKey: 'kuramoto',      paperIds: ['PAPER-XXXIII']          },
  wiring:        { formulaKey: 'kuramoto',      paperIds: ['PAPER-XXXIII']          },
  barter:        { formulaKey: 'loss_aversion', paperIds: ['PAPER-XXXIII']          },
  rental:        { formulaKey: 'loss_aversion', paperIds: ['PAPER-XXXIII']          },
  compensation:  { formulaKey: 'loss_aversion', paperIds: ['PAPER-XXXIII']          },
...
function handleManifest() {
  return {
    ...
    description:  'CONTEXTURA VIVA — The Living Context Engine. Holds ALL formulas, physics constants, and axioms ' +
                  'from all 35 papers. Can synthesize ANY topic by fusing paper substrates. Speaks with Freddy Voice.',
