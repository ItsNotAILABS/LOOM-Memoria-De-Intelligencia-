...
(function() {
  ...
  const bridge = {
    ...
    boot: function(workerPath) {
      ...
      var specializedWorkers = ['protocol', 'memory', 'communication', 'security', 'math', 'evolution', 'careers', 'protocols', 'taxonomy', 'veritas', 'sovereign-token', 'inference', 'houses', 'canister', 'cloudflare', 'lingua', 'agi-knowledge', 'papers', 'context', 'edge-gate', 'blockchain-edge', 'animus', 'cognitive-language'];
