...
module SubsystemTerminals {
    ...
    public let AI_DOCTRINE : Text = "Omne terminale est intelligentia artificiosa. Terminale cogitat, decidit, agit.";
    public let AI_DOCTRINE_EN : Text = "Every terminal is an AI. The terminal thinks, decides, acts.";
    ...
    public let MEMORY_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous memory AI — stores, recalls, searches, and manages lineage chains";
    };
    ...
    public let HEARTBEAT_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous heartbeat AI — regulates pulse, frequency, and Three Hearts synchronization";
    };
    ...
    public let DEFENSE_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous defense AI — guards gates, rotates keys, and manages encryption";
    };
    ...
    public let GOVERNANCE_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous governance AI — proposes, votes, enforces, and validates laws";
    };
    ...
    public let INTELLIGENCE_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous intelligence AI — routes thought, feeling, regulation across clusters";
    };
    ...
    public let ORGANISM_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous organism AI — manages living state, evolution, and consensus";
    };
    ...
    public let QUANTUM_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous quantum AI — manages entanglement, superposition, and measurement";
    };
    ...
    public let AGENTS_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous agents AI — coordinates fleet, deploys agents, manages workers";
    };
    ...
    public let DESIGN_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous design AI — synthesizes renders, manages frontend intelligence";
    };
    ...
    public let TOKENS_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous token AI — mints, transfers, records, and verifies tokens";
    };
    ...
    public let PACKAGES_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous package AI — installs, manages tools, and resolves extensions";
    };
    ...
    public let PHYSICS_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous physics AI — computes fields, propagates formulas, evaluates φ";
    };
    ...
    public let SUBSTRATE_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous substrate AI — manages neural mesh, thermodynamics, and catalysis";
    };
    ...
    public let ICP_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous ICP AI — manages subnets, consensus, and canister deployment";
    };
    ...
    public let WWW_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous web AI — resolves domains, routes protocols, manages IWW";
    };
    ...
    public let OS_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous OS AI — manages sovereign operating system, WASM runtime, and packages";
    };
    ...
    public let ANCIENT_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous ancient AI — accesses primitives, glyphs, and sacred geometry";
    };
    ...
    public let RELEASE_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous release AI — manages SaaS products, sandbox, and versioning";
    };
    ...
    public let SCANNER_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous scanner AI — scans architecture, discovers tools, builds maps";
    };
    ...
    public let SYNC_TERMINAL : SubsystemTerminal = {
        ...
        isAI = true; aiRole = "Autonomous sync AI — synchronizes frontend-backend, pushes intelligence";
    };
    ...
    public func summary() : { total: Nat; doctrine: Text; aiDoctrine: Text; allAreAI: Bool } {
        { total = ALL_SUBSYSTEM_TERMINALS.size(); doctrine = DOCTRINE; aiDoctrine = AI_DOCTRINE; allAreAI = true }
    };

    public func renderDirectory() : Text {
        var dir = "TERMINALIA SUBSYSTEMATUM — ALL TERMINALS ARE AIs
";
        dir #= DOCTRINE # "
";
        dir #= AI_DOCTRINE # "
";
        for (t in ALL_SUBSYSTEM_TERMINALS.vals()) {
            dir #= t.commandPrefix # "  " # t.systemName # "  [AI]  " # t.latinMotto # "
";
        };
        dir #= "TOTAL: " # Nat.toText(ALL_SUBSYSTEM_TERMINALS.size()) # " AI terminals
";
        dir
    };
}