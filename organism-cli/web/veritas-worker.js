...
(function() {
  ...
  var LANGS = [
    ...
    ['SOVEREIGN::LANG::CPL_L', 'LANGUAGE', 'CPL-Logic', 'Cognitive Procurement Logic — formal logic substrate for CPL contracts (PROT-113)'],
    ['SOVEREIGN::LANG::CPL_C', 'LANGUAGE', 'CPL-Contracts', 'Cognitive Contract Calculus — contract composition and verification (PROT-114)'],
    ['SOVEREIGN::LANG::CPL_P', 'LANGUAGE', 'CPL-Protocol', 'Cognitive Protocol Specification — organism communication protocols (PROT-115)'],
    ['SOVEREIGN::LANG::TPL', 'LANGUAGE', 'Toroidal Processing Language', 'Toroidal coordinate computations, Method of Loci, Kuramoto coupling (PROT-116)'],
    ['SOVEREIGN::LANG::CIL', 'LANGUAGE', 'Canister Instruction Language', 'Low-level canister operations, cycle accounting, stable memory (PROT-117)'],
    ['SOVEREIGN::LANG::CDL', 'LANGUAGE', 'Cognitive Definition Language', 'Schema definition with SCC validation, type theory, evolution rules (PROT-118)'],
    ['SOVEREIGN::LANG::OCL', 'LANGUAGE', 'Organism Communication Language', 'Inter-organism messaging, taxonomy-aware routing, coherence contracts (PROT-119)'],
    ['SOVEREIGN::LANG::ACL', 'LANGUAGE', 'Agent Communication Language', 'Agent-to-agent dialogue, BDI model, 181-house task delegation (PROT-120)'],
    ['SOVEREIGN::LANG::RSL', 'LANGUAGE', 'Resonance Specification Language', 'Frequency specs, Schumann harmonics, Solfeggio mappings (PROT-121)'],
    ['SOVEREIGN::LANG::SPL', 'LANGUAGE', 'Student Processing Language', 'Student cognitive modeling, φ-mastery, Fibonacci difficulty (PROT-122)'],
    ['SOVEREIGN::LANG::EDL', 'LANGUAGE', 'Educational Description Language', 'Curriculum design, prerequisite DAGs, assessment rubrics (PROT-123)'],
    ['SOVEREIGN::LANG::PWL', 'LANGUAGE', 'Pathway Learning Language', 'Adaptive learning paths, spaced repetition, mastery gates (PROT-124)'],
    ['SOVEREIGN::LANG::TSL', 'LANGUAGE', 'Teaching Specification Language', 'Pedagogy design, scaffolding patterns, differentiation rules (PROT-125)']
  ];
