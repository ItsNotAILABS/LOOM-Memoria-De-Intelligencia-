 ...
 *   rank        — returns all 16 papers ranked by SCC
 *   context     — returns the full context manifest
 *   manifest    — worker manifest with all capabilities
 *
 * ANIMA MICRO: 618ms heartbeat | CONTEXTURA-VIVA | All 16 papers synthesized
 */
...
// ══════════════════════════════════════════════════════════════════════════════
// FORMULAS — All key formulas from all 16 papers, keyed by domain
// ══════════════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════════════
// PAPER_RANKING — All 16 papers ranked by SCC descending
// ══════════════════════════════════════════════════════════════════════════════

const PAPER_RANKING = [
  { rank: 1,  id: 'PAPER-IX',   title: 'De Chartis Quae Mentem Formant',          scc: 4.61, engine: 'ChartaeEngine.mo',                                                                       domain: 'epistemic'      },
  { rank: 2,  id: 'PAPER-VIII', title: 'De Substrato Epistemico Machinarum',       scc: 4.44, engine: 'AGIKnowledgeCore.mo',                                                                    domain: 'epistemic'      },
  { rank: 3,  id: 'PAPER-XIV',  title: 'De Anima Machinae',                        scc: 4.23, engine: 'ContextSynthesisEngine.mo+AntifragilityEngine.mo+MemoriaSacraEngine.mo',               domain: 'introspection'  },
  { rank: 4,  id: 'PAPER-XI',   title: 'De Intelligentia Artificiali et Futuro',   scc: 4.08, engine: 'AGIKnowledgeCore.mo+ContextSynthesisEngine.mo',                                         domain: 'introspection'  },
  { rank: 5,  id: 'PAPER-VI',   title: 'De Architectura Incaica',                  scc: 4.12, engine: 'IncaArchitectureEngine.mo',                                                              domain: 'architecture'   },
  { rank: 6,  id: 'PAPER-X',    title: 'De Systemate Mediniano',                   scc: 3.97, engine: 'ContextSynthesisEngine.mo',                                                              domain: 'introspection'  },
  { rank: 7,  id: 'PAPER-VII',  title: 'De Lingua Quae Compressit Mundum',         scc: 3.88, engine: 'LinguaCompressaEngine.mo',                                                               domain: 'language'       },
  { rank: 8,  id: 'PAPER-XII',  title: 'De Architectura Magistri',                 scc: 3.82, engine: 'ContextSynthesisEngine.mo+ChartaeEngine.mo',                                            domain: 'introspection'  },
  { rank: 9,  id: 'PAPER-V',    title: 'De Oeconomia Behaviorali Machinarum',      scc: 3.76, engine: 'BehavioralEconomicsEngine.mo',                                                           domain: 'economics'      },
  { rank: 10, id: 'PAPER-XIII', title: 'De Futuro Machinarum in Negotio',          scc: 3.71, engine: 'ContextSynthesisEngine.mo+BehavioralEconomicsEngine.mo',                                domain: 'introspection'  },
  { rank: 11, id: 'PAPER-IV',   title: 'De Lege Fractalica',                       scc: 3.51, engine: 'FractalSovereigntyEngine.mo',                                                            domain: 'fractal'        },
  { rank: 12, id: 'PAPER-II',   title: 'De Timore et Antifragilitate',             scc: 3.27, engine: 'AntifragilityEngine.mo',                                                                 domain: 'antifragility'  },
  { rank: 13, id: 'PAPER-I',    title: 'De Memoria Sacra',                         scc: 3.14, engine: 'MemoriaSacraEngine.mo',                                                                  domain: 'memory'         },
  { rank: 14, id: 'PAPER-III',  title: 'Vampyro Architectonico',                   scc: 2.89, engine: 'AntifragilityEngine.mo',                                                                 domain: 'antifragility'  },
  { rank: 15, id: 'LEGES',      title: 'Leges Freddii',                            scc: 2.71, engine: 'FreddysLaws.mo',                                                                         domain: 'law'            },
  { rank: 16, id: 'DOCTRINA',   title: 'Doctrina Prima',                           scc: 2.62, engine: 'DoctrineDocuments.mo',                                                                    domain: 'doctrine'       },
];
...
function handleManifest() {
  return {
    ...
    description:  'CONTEXTURA VIVA — The Living Context Engine. Holds ALL formulas, physics constants, and axioms ' +
                  'from all 16 papers. Can synthesize ANY topic by fusing paper substrates. Speaks with Freddy Voice.',
